    ...
    <section>
        ...
        <div>
            ...
            <div>
                ...
                <div className="flex flex-col items-center">
                    <FullBanner href="/games/enemyzero" backgroundImg={EZBackground} logo={<EnemyZeroLogo />}></FullBanner>
                    <h4 className="prose prose-gray text-center mb-4">A proof-of-concept VR remake of WARP's cult classic horror game <i>Enemy Zero</i>!</h4>
                </div>
