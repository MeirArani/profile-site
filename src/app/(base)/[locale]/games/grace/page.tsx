...
export default function Page({params: locale}) {
  ...
  return (
    <section className="lg:mx-48 md:mx-16 xl:mx-72 2xl:mx-72">
        <h1 className="text-5xl"><i>Grace Beneath the Pines</i></h1>
        <FullAV className="" fallback={BeautyBackground}></FullAV>
        <div>
          <div>
              <ul className="text-sm">
                <li><b>Genre: </b>JRPG</li>
                <li><b>The Pitch:</b> <i>A survival horror inspired JPRG mixing complex narrative with permadeath mechanics.</i></li>
              </ul>
          </div>
