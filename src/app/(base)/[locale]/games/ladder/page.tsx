...
export default function Page({params: locale}) {
  ...
  return (
    <section className="lg:mx-48 md:mx-16 xl:mx-72 2xl:mx-72">
        <h1 className="text-5xl"><i>Corporate Ladder</i></h1>
        <h3 className="mt-6"><i>Co-designed with Emma Chapman and Shiloh Beeler</i></h3>
        <FullAV className="" fallback={cooler}></FullAV>
        <div>
          <div>
              <ul className="text-sm">
                <li><b>Genre: </b>Life Sim / Visual Novel / Microgame</li>
                <li><b>The Pitch:</b><i> An roaring satire of corporate life inspired by the likes of Animal Crossing, Persona, Warioware, and Papers Please.</i></li>
              </ul>
          </div>
          ...
          <div className="mb-1">
            ...
            <div className="prose prose-gray mb-6">
              ...
              <FullAV className="" fallback={cooler} caption="Beauty concept art"></FullAV>
              <p>
              ...
              <FullAV className="" fallback={cooler} caption="Beast concept art"></FullAV>
              <p>
